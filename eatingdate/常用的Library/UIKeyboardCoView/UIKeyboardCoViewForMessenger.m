//
//  UIKeyboardCoViewForMessenger.m
//  taiwan8
//
...
#import "UIKeyboardCoViewForMessenger.h"

@interface UIKeyboardCoViewForMessenger ()
/**
...
@implementation UIKeyboardCoViewForMessenger
...
- (void) keyboardWillDisappear:(NSNotification*)notification{
    ...
    if (!self.isRotating){
        ...
        //Get this view begin and end rect
        CGRect selfBeginRect = CGRectMake(beginRect.origin.x,
                                          beginRect.origin.y - self.frame.size.height - 60,
                                          beginRect.size.width,
                                          self.frame.size.height);
        CGRect selfEndingRect = CGRectMake(endRect.origin.x,
                                           endRect.origin.y - self.frame.size.height - 60,
                                           endRect.size.width,
                                           self.frame.size.height);
